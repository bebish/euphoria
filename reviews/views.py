...
from .serializers import FragnanceReviewSerializer, ReviewCommentSerializer, LikeSerializer, OrderSerializer, OrderItemSerializer, RatingSerializer
...
class FragnanceReviewViewSet(ModelViewSet):
    ...
    filterset_fields = ['title', 'brand', 'rating']  
